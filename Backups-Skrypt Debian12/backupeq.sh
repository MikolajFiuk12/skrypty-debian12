...
# KONFIGURACJA
# -----------------------------
SOURCE="/DATA/AppData/crafty/servers/77d501ad-b83a-4c53-8468-ab6a3897834c/world/players/data"   # folder do backupu
DEST="/opt/equ"            # folder docelowy backupów
MAX_BACKUPS=100                  # ile backupów przechowywać
